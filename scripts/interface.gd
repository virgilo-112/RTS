...
@onready var wood_label: Label = $PanelContainer/VBoxContainer/HBoxContainer/WoodLabel
@onready var coin_label: Label = $PanelContainer/VBoxContainer/HBoxContainer3/CoinLabel
@onready var food_label: Label = $PanelContainer/VBoxContainer/HBoxContainer2/FoodLabel
